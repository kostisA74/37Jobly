...
router.get("/:username", ensureLoggedIn, ensureIsAdminOrSpecUser ,async function (req, res, next) {
  try {
...
router.patch("/:username", ensureLoggedIn, ensureIsAdminOrSpecUser ,async function (req, res, next) {
  try {
...
router.delete("/:username", ensureLoggedIn, ensureIsAdminOrSpecUser, async function (req, res, next) {
  try {
